...
<div class="super_container">
	...
	<div class="home">
		<div class="home_background_container prlx_parent">
			<div class="home_background prlx" style="background-image:url(images/coorso_back.jpg)"></div>
		</div>
				...
				<div class="col-lg-4 course_box">
					<div class="card">
						...
						<div class="card-body text-center">
							...
							<div class="card-text">Adobe Guide, Layes, Smart Objects etc...</div><p>
							<div class="card-text">Dificultad: <strong> avanzado</strong></div>
						...
						<div class="price_box d-flex flex-row align-items-center">
							...
							<div class="course_author_name">Michael Smith, <span>Maestro</span></div>
