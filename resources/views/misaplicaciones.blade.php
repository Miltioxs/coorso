			...
			<div class="row">
				<div class="col">
					<div class="section_title text-center">
						<h1>Mis Aplicaciones a ofertas</h1>
					</div>
				</div>
			</div>
						...
						@foreach($aplicacion as $aplicacion)
							...
							<!-- Popular Course Item -->
									...
									<div class="price_box d-flex flex-row align-items-center">
										<div class="course_author_name">{{$aplicacion->nombreE}} <span></span></div>
										@if($aplicacion->estadoO == 0)
											<div class="course_price d-flex flex-column align-items-center justify-content-center fondoA"><span class="glyphicon glyphicon-ok">P</span></div>
										@elseif($aplicacion->estadoO == 1)
											<div class="course_price d-flex flex-column align-items-center justify-content-center fondoR"><span class="glyphicon glyphicon-ok">R</span></div>
										@else
											<div class="course_price d-flex flex-column align-items-center justify-content-center fondoA"><span class="glyphicon glyphicon-ok">A</span></div>
										@endif	
