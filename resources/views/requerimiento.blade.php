    ...
    <div class="super_container">
            ...
            <div class="menu_inner menu_mm">
                <div class="menu menu_mm">
                    <ul class="menu_list menu_mm">
                        ...
                        <li class="menu_item menu_mm"><a href="buscar.html">Buscar</a></li>
        ...
        <footer class="footer">
            <div class="container">
                ...
                <div class="container">
                    <div class="row align-items-left sinmargen">
                        <div class="col-lg-6 col-sm-12 float_left">
                            <div class="">

                                <ul class="list-group">
                                    <li class="list-group-item active">Puesto</li>
                        ...
                        <div class="col-lg-6 col-sm-12 float_right">
                            ...
                            <ul class="list-group">
                                <li class="list-group-item active">Empresa</li>
                                <li class="list-group-item ">First item</li>
